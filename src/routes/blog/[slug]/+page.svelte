...
<svelte:head>
	<title>{post.title} - vonshlovens</title>
...
<article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
	...
	<header class="mb-12">
		<div class="text-center">
			...
			<div class="flex items-center justify-center text-gray-600 dark:text-gray-400 mb-6">
	...
	<footer class="mt-16 pt-8 border-t border-gray-200 dark:border-gray-700">
		<div class="flex justify-between items-center">
			...
			<div class="flex items-center space-x-4">
				<span class="text-gray-600 dark:text-gray-400 text-sm">Share:</span>			<a 
				href="https://twitter.com/intent/tweet?text={encodeURIComponent(post.title)}&url={encodeURIComponent(`https://vonshlovens.github.io/vonshlovens/blog/${post.slug}`)}"
				target="_blank"
